...
const ToastViewport = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/React.createElement(ToastPrimitives.Viewport, {
  ref: ref,
...
const Toast = /*#__PURE__*/React.forwardRef(({
  ...
  return /*#__PURE__*/React.createElement(ToastPrimitives.Root, {
    ref: ref,
...
const ToastAction = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/React.createElement(ToastPrimitives.Action, {
  ref: ref,
...
const ToastClose = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/React.createElement(ToastPrimitives.Close, {
  ref: ref,
...
const ToastTitle = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/React.createElement(ToastPrimitives.Title, {
  ref: ref,
...
const ToastDescription = /*#__PURE__*/React.forwardRef(({
  className,
  ...props
}, ref) => /*#__PURE__*/React.createElement(ToastPrimitives.Description, {
  ref: ref,
